...
<script language="javascript">
	...
	function LoadPage() {
		...
		initSheet.Cols = [
			...
			{Header:"ID",Type:"Text",SaveName:"id",MinWidth:80,Align:"Center"},
			{Header:"비밀번호",Type:"Text",SaveName:"pwd",MinWidth:80,KeyField:1 ,MultiLineText:1},			
	...
	function doAction(sAction) {
		switch(sAction) {
			case "search": //조회
				...
				mySheet.DoSearch("${contextPath}/hm/s0001/searchList.do", param);
			...
			case "save": // 저장
				...
				mySheet.DoSave("${contextPath}/hm/s0001/saveData.do");
				break;			
			case "insert": //신규행 추가
